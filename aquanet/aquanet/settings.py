"""
Django settings for aquanet project.
...
SECRET_KEY = 'd!g&f4g6wui%++vugj2+pd49ek-(kr6mx5klwa429s=!dz2!(v'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'aquanet.context_processors.get_unread_threads'
            ],
        },
    },
]
